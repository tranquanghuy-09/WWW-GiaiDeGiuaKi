...
<div class="container col-4 mx-auto mt-5">
    ...
    <form action="" class="mt-5">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="id" value="<%=candidate.getId()%>" disabled>
        </div>
        <div class="form-group">
            <label for="fullname">Full Name:</label>
            <input type="text" class="form-control" id="fullname" value="<%=candidate.getFullName()%>" disabled>
        </div>
        <div class="form-group">
            <label for="email">Email:</label>
            <input type="text" class="form-control" id="email" value="<%=candidate.getId()%>" disabled>
        </div>
        <div class="form-group">
            <label for="phone">Phone:</label>
            <input type="text" class="form-control" id="phone" value="<%=candidate.getPhone()%>" disabled>
        </div>
    </form>
</div>
